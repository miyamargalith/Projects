...
public class Specification {
	...
	// Bumper
	public static final double F_BUMPER_LENGTH = 0.25*F_LENGTH; //0.15
	public static final double F_BUMPER_DEPTH = 0.5*F_HOOD_DEPTH_1; //0.2
	public static final double F_BUMPER_HEIGHT_2 = 5e-4;
	public static final double F_BUMPER_HEIGHT_1 = 0.25*F_HOOD_HEIGHT_2; //0.2812
	public static final double F_BUMPER_WINGS_DEPTH = 0.8*0.5*(F_HOOD_DEPTH_1-F_BUMPER_DEPTH); //0.08000
	public static final double F_BUMPER_WINGS_HEIGHT_1 = 0.75*F_HOOD_HEIGHT_1; //0.9843
	public static final double F_BUMPER_WINGS_HEIGHT_2 = F_BUMPER_HEIGHT_2; //5e-4
