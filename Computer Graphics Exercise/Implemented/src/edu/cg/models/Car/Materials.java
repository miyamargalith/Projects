...
public class Materials {
	...
	private static final float dark_gray[] = { 0.0f, 0.0f, 0.0f };
	...
	private static final float yellow[] = {1.0f, 1.0f, 0.8f};
	private static final float pink[] = {1.0f, 0.75f, 0.76f};
	private static final float lightPink[] = {1.0f, 0.90f, 0.91f};
	private static final float brown[] = {0.39f, 0.35f, 0.17f};
	...
	public static void SetYellowMetalMaterial(GL2 gl) {
		SetMetalMaterial(gl, yellow);
	}


	public static void SetPinkMetalMaterial(GL2 gl) {
		SetMetalMaterial(gl, pink);
	}


	public static void SetLightPinkMetalMaterial(GL2 gl) {
		SetMetalMaterial(gl, lightPink);
	}
	...
	public static void SetBrownMetalMaterial(GL2 gl) {
		SetMetalMaterial(gl, brown);
	}
